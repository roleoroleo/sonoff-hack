...
#
# Command line:
# 	ash "/mnt/mmc/sonoff-hack/script/thumb.sh" cron
# 	ash "/mnt/mmc/sonoff-hack/script/thumb.sh" start
# 	ash "/mnt/mmc/sonoff-hack/script/thumb.sh" stop
#
CONF_FILE="etc/system.conf"

YI_HACK_PREFIX="/mnt/mmc/sonoff-hack"
